...
stra::QuantOrder PairOrder::CreatePassiveOrder(int64_t strategyOrderId, PositionManager* posMgr) {
    ...
    if (strcmp(activeInfo.quote, baseAsset) == 0 || ((strcmp(activeInfo.quote, "USDT") == 0 || strcmp(activeInfo.quote, "USD") == 0 || strcmp(activeInfo.quote, "USDC") == 0 || strcmp(activeInfo.quote, "BUSD") == 0) && (strcmp(baseAsset, "USDT") == 0 || strcmp(baseAsset, "USD") == 0 || strcmp(baseAsset, "USDC") == 0 || strcmp(baseAsset, "BUSD") == 0))) {
	    ...
	    LOG_INFO("CreatePassiveOrder leftAss:{} activeAmount:{} leftAss.totalAmount:{} loanAmount:{}", activeInfo.base, activeAmount, leftAss.totalAmount, leftAss.loanAmount);
        if (activeInfo.calcType == 0) {
    ...
    LOG_INFO("CreatePassiveOrder activeAmount:{} activeValue:{} passiveAmount:{} passiveValue:{}", activeAmount, activeInfo.value, passiveAmount, passiveInfo.value);
